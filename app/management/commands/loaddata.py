...
random_names = [
    "Tanaka", "Charmaine", "Tafara", "Mitchie", "Mitchell", "Tadiwa", "John", "Ngonie", "Caleb", "Chichi", "Tinaye",
    "Josh",
    "Munashe", "Jones", "Mat", "Jeff", "Neuro", "Nelson", "Shinga", "Ray", "Sly", "Hawk", "Tim", "Tom", "David",
    "Nigga", "Coi",
    "Lisa", "Love", "Chommie"
]

placeholder = ("Lorem, ipsum dolor sit amet consectetur adipisicing elit. Suscipit dicta quibusdam saepe voluptas "
               "molestiae, ipsam nesciunt praesentium modi aperiam voluptates qui molestias quaerat minima adipisci "
               "provident. Provident voluptatem perferendis quisquam!")
                    ...
                    for i in range(3):
                        ...
                        bpp = save_super_form(app_models.BurialPlacePurchase, dict(
                            ...
                            religion=random.choice(
                                ["Christian", "ATR", "Islam", "Hindi", "Budhist", "Atheist", "Jew", "Other"]),
                            marital_status=random.choice(
                                ["Maried", "Single", "Divorced", "Widowed", "Engaged", "Partnered"]),
                        ...
                        for i in range(bp.number_of_beneficiaries):
                            bnf = save_super_form(app_models.Beneficiary, dict(
                                ...
                                relationship=random.choice(
                                    ["Sibling", "friend", "spouse", "churchmate", "workmate", "other"]),
                                created_by=c,
